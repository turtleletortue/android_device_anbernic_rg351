...
$(call inherit-product, device/anbernic/rg351v/device.mk)

# Boot animation
TARGET_SCREEN_HEIGHT := 480
TARGET_SCREEN_WIDTH := 640

PRODUCT_NAME := lineage_rg351v
PRODUCT_DEVICE := rg351v
PRODUCT_MANUFACTURER := Anbernic
PRODUCT_BRAND := Anbernic
PRODUCT_MODEL := LineageOS for Anbernic RG351V


PRODUCT_GMS_CLIENTID_BASE := android-rockchip

PRODUCT_BUILD_PROP_OVERRIDES += \
	TARGET_DEVICE="rg351v" \
	PRODUCT_NAME="rg351v" \
	PRIVATE_BUILD_DESC="lineage_rg351v-userdebug 11 RP1A.201005.004 test-keys"
